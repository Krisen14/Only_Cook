...
public final class ItemReceiptBinding implements ViewBinding {
  ...
  private ItemReceiptBinding(@NonNull CardView rootView, @NonNull TextView receiptDate,
      @NonNull TextView receiptDesc, @NonNull ImageView receiptImage,
      @NonNull TextView receiptName) {
  ...
  public static ItemReceiptBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReceiptBinding((CardView) rootView, receiptDate, receiptDesc, receiptImage,
          receiptName);
    }
